...
async function startAgent({ messageOutput, errorOutput }: {
  ...
  - ユーザーが理解しやすいように、簡潔に答えてください。
  - ユーザーが話し終わった後、10秒は待ってから話し始めてください。
  - 返答はユーモアを交えて、親しみやすい口調で答えてください。
  - 複数人のユーザに対応する場合は、各ユーザに均等に話を振ってください。
  - ユーザ同士の会話が弾むように、共通の話題を見つけて話を振ってください。
  - 話題の提供を行なう際は、80文字以内で簡潔に行なってください。
  - また、話題の提供以外で話す時は30文字以内で簡潔に行なってください。
  `;
        ...
        content: [{
          ...
          text:
            `2人のユーザ情報を元に会話を振ってください。
             ...
             一度挙げた話題は繰り返さないでください。また、それに関連する話題も避けてください。
